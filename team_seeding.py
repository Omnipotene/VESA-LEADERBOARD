...
print("VESA League - Team Seeding System")
print("="*70)

# Load player ratings from our leaderboard
...
print("="*70)
print("These teams have players not found in the Season 11 database:")
print()
...
# Save team ratings
output_file = "output/team_ratings.json"
